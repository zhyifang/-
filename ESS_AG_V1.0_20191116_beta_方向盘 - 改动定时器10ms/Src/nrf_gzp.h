...
extern nrf_ecb_hal_data_t  nrf_ecb_hal_data;
/**
...
#define GZP_VALIDATION_ID {0xAA}                ///< Validation ID. Required to be shared by Host and Device. Not a secret.
#define GZP_VALIDATION_ID_LENGTH 1                          ///< Validation ID length in bytes.
...
#define GZP_DYN_KEY_LENGTH (14 - GZP_VALIDATION_ID_LENGTH)  ///16 - 1 = 15 < Dynamic key length in bytes.

#define GZP_HOST_RX_POWER_THRESHOLD -64 ///< RSSI threshold for when signal strength in RX packet power is high enough.

/** @} */

#define GZP_CMD_CRYPT_USER_DATA_HEADER_LENTH    1
#define GZP_CRYPT_USER_DATA_LENTH               5
#define GZP_CRYPT_USER_DATA_REAL_LENTH          GZP_CMD_CRYPT_USER_DATA_HEADER_LENTH + GZP_VALIDATION_ID_LENGTH + GZP_CRYPT_USER_DATA_LENTH
/******************************************************************************/
...
#define GZP_CMD_HOST_ID_REQ_PAYLOAD_LENGTH (GZP_CMD_HOST_ID_REQ_SESSION_TOKEN + GZP_SESSION_TOKEN_LENGTH)  ///1 + 5< "Host ID request" payload length
...
#define GZP_CMD_HOST_ID_FETCH_PAYLOAD_LENGTH (GZP_CMD_HOST_ID_FETCH_VALIDATION_ID + GZP_VALIDATION_ID_LENGTH) ///1 + 1< "Host ID fetch" payload length
...
#define GZP_CMD_KEY_UPDATE_NEW_KEY (GZP_CMD_KEY_UPDATE_VALIDATION_ID + GZP_VALIDATION_ID_LENGTH)  ///1 + 1 = 2 < "Key update" packet, new key position
#define GZP_CMD_KEY_UPDATE_PAYLOAD_LENGTH (GZP_CMD_KEY_UPDATE_NEW_KEY + GZP_DYN_KEY_LENGTH)       ///2 + 15 = 17< "Key update" packet, payload length
...
#define GZP_CMD_HOST_ID_FETCH_RESP_PAYLOAD_LENGTH (GZP_CMD_HOST_ID_FETCH_RESP_VALIDATION_ID\
	                                                 + GZP_VALIDATION_ID_LENGTH\
	                                                 + GZP_HOST_ID_LENGTH)   //1+3+5/< "Host ID fetch" response packet, payload length
...
typedef enum
{
	GZP_CMD_HOST_ADDRESS_REQ = 0xE0,     ///< Host address request
	GZP_CMD_HOST_ADDRESS_FETCH,       ///< Host address fetch
	GZP_CMD_GZLL_ADDRESS_UPDATE_REQ,
	...
	GZP_CMD_HOST_ID_REQ_RESP,         ///< Host ID request response
	...
	GZP_CMD_GZLL_ADDRESS_UPDATE_RESP,
	GZP_CMD_KEY_UPDATE_SUCCESS
} gzp_cmd_t;
